                    ...
                    <div class="js-silder ws-slider">
                        <div class="silder-scroll">
                            <div class="silder-main">
                                <c:forEach items="${mppt}" var="mppt">
                                    <div class="silder-main-img">
                                        <a href="#"><img src="${mppt.pic}" alt="${mppt.title}" title="${mppt.title}"/></a>
                                    </div>
                                </c:forEach>
                                <%--<div class="silder-main-img">--%>
                                    <%--<a href="#"><img src="/static/images/liuceng_1.jpg" alt="1" title="1"></a>--%>
                                <%--</div>--%>
                                <%--<div class="silder-main-img">--%>
                                    <%--<a href="#"><img src="/static/images/2.png" alt="2"></a>--%>
                                <%--</div>--%>
                                <%--<div class="silder-main-img">--%>
                                    <%--<a href="#"><img src="/static/images/3.png" alt="3"></a>--%>
                                <%--</div>--%>
                            </div>
                        </div>

            ...
            <li class="denglu dengl_hou">
                ...
                <div class="dengl_hou_xial_k">
                    <div class="zuid_xiao_toux">
                        <a href="#"><img src="/static/images/toux.png"></a>
                    </div>
    ...
    <div class="cart-shop-goods dangq_honh">
        <div class="cart-shop-good">
            ...
            <div class="cart-col-2" style="height: 82px;">
                <a href="" target="_blank" class="g-img"><img src="/static/images/xiangqtu_1.jpg" alt=""></a>
            </div>
            <div class="fl houj_c">
        ...
        <div class="investment_con">
            ...
            <div class="picScroll_left_s"  style="display: block;">
                ...
                <div class="bd">
                    <ul class="picList">
                        <li>
                            <div class="pic"><a href="#" target="_blank"><img src="/static/images/lieb_tupi3.jpg" /></a></div>
                            <div class="title">
                        ...
                        <li>
                            <div class="pic"><a href="#" target="_blank"><img src="/static/images/shangq_3.jpg" /></a></div>
                            <div class="title">
                                <a href="#" target="_blank">喜芬妮春秋桑蚕丝长袖性感蕾丝花边女式睡衣家居服二</a>
                                <div class="jiage_gouw"><span>¥2499.00</span></div>
                                <a href="#" class="cart_scroll_btn">加入购物车</a>
                        ...
                        <li>
                            <div class="pic"><a href="#" target="_blank"><img src="/static/images/big_3.jpg" /></a></div>
                            <div class="title">
                                <a href="#" target="_blank">喜芬妮春秋桑蚕丝长袖性感蕾丝花边女式睡衣家居服二</a>
                                <div class="jiage_gouw"><span>¥2499.00</span></div>
                                <a href="#" class="cart_scroll_btn">加入购物车</a>
                        ...
                        <li>
                            <div class="pic"><a href="#" target="_blank"><img src="/static/images/xiangqtu_1.jpg" /></a></div>
                            <div class="title">
                                <a href="#" target="_blank">喜芬妮春秋桑蚕丝长袖性感蕾丝花边女式睡衣家居服二</a>
                                <div class="jiage_gouw"><span>¥2499.00</span></div>
                                <a href="#" class="cart_scroll_btn">加入购物车</a>
                        ...
                        <li>
                            <div class="pic"><a href="#" target="_blank"><img src="/static/images/lieb_tupi1.jpg" /></a></div>
                            <div class="title">
                                <a href="#" target="_blank">喜芬妮春秋桑蚕丝长袖性感蕾丝花边女式睡衣家居服二</a>
                                <div class="jiage_gouw"><span>¥2499.00</span></div>
                                <a href="#" class="cart_scroll_btn">加入购物车</a>
                        ...
                        <li>
                            <div class="pic"><a href="#" target="_blank"><img src="/static/images/lieb_tupi2.jpg" /></a></div>
                            <div class="title">
                                <a href="#" target="_blank">喜芬妮春秋桑蚕丝长袖性感蕾丝花边女式睡衣家居服二</a>
                                <div class="jiage_gouw"><span>¥2499.00</span></div>
                                <a href="#" class="cart_scroll_btn">加入购物车</a>
...
</table><table width="750" border="0" align="center" cellpadding="0" cellspacing="6">
    <tr>
        <td><p class="formwork_titleleft">智慧阅读</p><p class="formwork_titleleft2">看到新单词想知道它的意思？问题！在华为Ascend P6 长按这个词就可以同屏通过字典或者搜索引擎快速查询它的意思。</p></td>
        <td><img src="http://img20.360buyimg.com/vc/g15/M02/02/16/rBEhWFHKSSQIAAAAAABJ9l3VCCQAAAh4QP_kKUAAEoO222.jpg" /></td>
    </tr>
</table><table width="750" border="0" align="center" cellpadding="0" cellspacing="6">
    <tr>
        <td><img src="http://img20.360buyimg.com/vc/g15/M04/02/16/rBEhWFHKSWIIAAAAAAAS2TRk30QAAAh4wEF7UUAABLx080.jpg" /></td>
        <td><p class="formwork_titleleft">智能节电</p><p class="formwork_titleleft2">华为Ascend P6在芯片级、硬件级和软件级三个层面上做到智能节电，是手机的电力使用时间提升高达30%。您亦可以一次性关闭后台运行的所有程序，便捷提高手机使用的效率。</p></td>
    </tr>
</table></div>
</body>
</html>

                        ...
                        <form:form id="inputForm" cssClass="form-horizontal" action="/content/save" method="post" modelAttribute="tbContent">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control" path="url" placeholder="链接"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control" path="pic" placeholder="图片1"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control" path="pic2" placeholder="图片2"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <%--<form:textarea class="form-control required" path="content" placeholder="详情" rows="6"/>--%>
